...
import xyz.vaillant.poc.core.exception.user.InsufficientOnboardingLevelException;
import xyz.vaillant.poc.core.exception.user.UserNotFoundException;
...
import xyz.vaillant.poc.core.repository.ClanRepository;
